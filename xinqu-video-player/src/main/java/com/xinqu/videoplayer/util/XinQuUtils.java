...
public class XinQuUtils {
    ...
    public static void setRequestedOrientation(Context context, int orientation) {
        if (XinQuUtils.getAppCompActivity(context) != null) {
            XinQuUtils.getAppCompActivity(context).setRequestedOrientation(orientation);
        } else {
            XinQuUtils.scanForActivity(context).setRequestedOrientation(orientation);
        }
    }
    ...
    public static Object getCurrentFromDataSource(Object[] dataSourceObjects, int index) {
        if(null!=dataSourceObjects&&dataSourceObjects.length>0){
