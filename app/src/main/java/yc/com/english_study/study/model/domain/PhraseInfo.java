 ...
 * 短语
 */
public class PhraseInfo extends BaseObservable implements Parcelable {
    /**
     * id : 1
     * vid : 1
     * phrase : gr#ee#n t#ea#
    ...
    public static final Parcelable.Creator<PhraseInfo> CREATOR = new Parcelable.Creator<PhraseInfo>() {
        @Override
