 ...
 * 句子
 */
public class SentenceInfo extends BaseObservable implements Parcelable {
    /**
     * id : 1
     * vid : 1
    ...
    public static final Parcelable.Creator<SentenceInfo> CREATOR = new Parcelable.Creator<SentenceInfo>() {
        @Override
