...
//        mSeekBar.setOnSeekBarChangeListener(new MySeekBarListener());
    ...
    private void play() {
        ...
        try {
            ...
            mImageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.mipmap.study_essentials_stop_btn));
    ...
    public void pause() {
        try {
            if (null != mediaPlayer && currentState == STATE_START) {
                ...
                mImageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.mipmap.study_essentials_play_btn));
                mediaPlayer.pause();
            }
        } catch (Exception e) {
        }
