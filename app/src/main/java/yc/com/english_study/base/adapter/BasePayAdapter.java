package yc.com.english_study.base.adapter;
...
import yc.com.english_study.databinding.VipInfoItemBinding;
 ...
 */
public class BasePayAdapter extends BaseBindingAdapter<GoodInfo, VipInfoItemBinding, BaseBindingHolder<VipInfoItemBinding>> {
    ...
    @Override
    protected void convert(BaseBindingHolder<VipInfoItemBinding> helper, GoodInfo item) {
